...
export const projects: Project[] = [
  ...
  },
  {
    ...
    shortDescription: "Part of Videoke Philippines at Daadgalerie in Berlin",
    description:
      "Part of Videoke Philippines, a special showcase of the works of the film and art collective Furball, held in Daadgalerie in Berlin.",
